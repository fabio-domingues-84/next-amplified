...
export default function SkillCreateForm(props) {
  ...
  const [trackingName, setTrackingName] = React.useState(
    initialValues.trackingName
  );
  ...
  const resetStateValues = () => {
    ...
    setTrackingName(initialValues.trackingName);
    ...
    >
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.trackingName ?? value;
          }
          if (errors.trackingName?.hasError) {
            runValidationTasks("trackingName", value);
          }
          setTrackingName(value);
        }}
        onBlur={() => runValidationTasks("trackingName", trackingName)}
        errorMessage={errors.trackingName?.errorMessage}
        hasError={errors.trackingName?.hasError}
        {...getOverrideProps(overrides, "trackingName")}
      ></TextField>
      <TextField
        label="Description"
        isRequired={false}
      ...
      <ArrayField
        ...
        runValidationTasks={async () =>
          await runValidationTasks("games", currentGamesValue)
        }
